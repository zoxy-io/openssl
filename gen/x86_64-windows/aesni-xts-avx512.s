...
.def	aesni_xts_avx512_eligible;	.scl 2;	.type 32;	.endef
.p2align	5
...
.def	aesni_xts_128_encrypt_avx512;	.scl 2;	.type 32;	.endef
.p2align	5
aesni_xts_128_encrypt_avx512:
	movq	%rdi,8(%rsp)
	movq	%rsi,16(%rsp)
	movq	%rsp,%rax
.LSEH_begin_aesni_xts_128_encrypt_avx512:
	movq	%rcx,%rdi
	movq	%rdx,%rsi
	movq	%r8,%rdx
	movq	%r9,%rcx
...
.byte	243,15,30,250
	...
	movq	%rdi,288 + 8(%rsp)
	movq	%rsi,288 + 16(%rsp)
	vmovdqa	%xmm6,128 + 0(%rsp)
	vmovdqa	%xmm7,128 + 16(%rsp)
	vmovdqa	%xmm8,128 + 32(%rsp)
	vmovdqa	%xmm9,128 + 48(%rsp)
	vmovdqa	%xmm10,128 + 64(%rsp)
	vmovdqa	%xmm11,128 + 80(%rsp)
	vmovdqa	%xmm12,128 + 96(%rsp)
	vmovdqa	%xmm13,128 + 112(%rsp)
	vmovdqa	%xmm14,128 + 128(%rsp)
	vmovdqa	%xmm15,128 + 144(%rsp)
	movq	$0x87,%r10
	vmovdqu	(%r9),%xmm1
	vpxor	(%r8),%xmm1,%xmm1
...
.L_ret_hEgxyDlCngwrfFe:
	...
	vmovdqa	128 + 0(%rsp),%xmm6
	vmovdqa	128 + 16(%rsp),%xmm7
	vmovdqa	128 + 32(%rsp),%xmm8
	vmovdqa	128 + 48(%rsp),%xmm9


	vmovdqa64	%zmm0,128(%rsp)

	vmovdqa	128 + 64(%rsp),%xmm10
	vmovdqa	128 + 80(%rsp),%xmm11
	vmovdqa	128 + 96(%rsp),%xmm12
	vmovdqa	128 + 112(%rsp),%xmm13


	vmovdqa64	%zmm0,128 + 64(%rsp)

	vmovdqa	128 + 128(%rsp),%xmm14
	vmovdqa	128 + 144(%rsp),%xmm15



	vmovdqa	%ymm0,128 + 128(%rsp)
	movq	%rbp,%rsp
	popq	%rbp
	vzeroupper
	movq	8(%rsp),%rdi
...
.def	aesni_xts_128_decrypt_avx512;	.scl 2;	.type 32;	.endef
.p2align	5
aesni_xts_128_decrypt_avx512:
	movq	%rdi,8(%rsp)
	movq	%rsi,16(%rsp)
	movq	%rsp,%rax
.LSEH_begin_aesni_xts_128_decrypt_avx512:
	movq	%rcx,%rdi
	movq	%rdx,%rsi
	movq	%r8,%rdx
	movq	%r9,%rcx
...
.def	aesni_xts_256_encrypt_avx512;	.scl 2;	.type 32;	.endef
.p2align	5
aesni_xts_256_encrypt_avx512:
	movq	%rdi,8(%rsp)
	movq	%rsi,16(%rsp)
	movq	%rsp,%rax
.LSEH_begin_aesni_xts_256_encrypt_avx512:
	movq	%rcx,%rdi
	movq	%rdx,%rsi
	movq	%r8,%rdx
	movq	%r9,%rcx
...
.def	aesni_xts_256_decrypt_avx512;	.scl 2;	.type 32;	.endef
.p2align	5
aesni_xts_256_decrypt_avx512:
	movq	%rdi,8(%rsp)
	movq	%rsi,16(%rsp)
	movq	%rsp,%rax
.LSEH_begin_aesni_xts_256_decrypt_avx512:
	movq	%rcx,%rdi
	movq	%rdx,%rsi
	movq	%r8,%rdx
	movq	%r9,%rcx
