...
.def	ossl_rsaz_amm52x30_x1_ifma256;	.scl 2;	.type 32;	.endef
.p2align	5
...
.byte	243,15,30,250
	...
	leaq	-168(%rsp),%rsp
	vmovdqa64	%xmm6,0(%rsp)
	vmovdqa64	%xmm7,16(%rsp)
	vmovdqa64	%xmm8,32(%rsp)
	vmovdqa64	%xmm9,48(%rsp)
	vmovdqa64	%xmm10,64(%rsp)
	vmovdqa64	%xmm11,80(%rsp)
	vmovdqa64	%xmm12,96(%rsp)
	vmovdqa64	%xmm13,112(%rsp)
	vmovdqa64	%xmm14,128(%rsp)
	vmovdqa64	%xmm15,144(%rsp)
...
.Lloop7:
	...
	vmovdqa64	0(%rax),%xmm6
	vmovdqa64	16(%rax),%xmm7
	vmovdqa64	32(%rax),%xmm8
	vmovdqa64	48(%rax),%xmm9
	vmovdqa64	64(%rax),%xmm10
	vmovdqa64	80(%rax),%xmm11
	vmovdqa64	96(%rax),%xmm12
	vmovdqa64	112(%rax),%xmm13
	vmovdqa64	128(%rax),%xmm14
	vmovdqa64	144(%rax),%xmm15
	leaq	168(%rsp),%rax
	movq	0(%rax),%r15
...
.def	ossl_rsaz_amm52x30_x2_ifma256;	.scl 2;	.type 32;	.endef
.p2align	5
...
.def	ossl_extract_multiplier_2x30_win5;	.scl 2;	.type 32;	.endef
ossl_extract_multiplier_2x30_win5:

.byte	243,15,30,250
	vmovdqa64	.Lones(%rip),%ymm30
	vpbroadcastq	%r8,%ymm28
	vpbroadcastq	%r9,%ymm29
	leaq	16384(%rdx),%rax
...
.Lloop:
	...
	vmovdqu64	%ymm20,320(%rcx)
	vmovdqu64	%ymm21,352(%rcx)
	vmovdqu64	%ymm22,384(%rcx)
	vmovdqu64	%ymm23,416(%rcx)
	vmovdqu64	%ymm24,448(%rcx)
	vmovdqu64	%ymm25,480(%rcx)
